...
function EventCard({ eventId } : { eventId: Id<"events"> }) {
    ...
    const availableTickets = useQuery(api.events.getEventAvailability, {eventId})
    ...
    const queuePosition = useQuery(api.waitingList.getQueuePosition, {
      ...
      const renderQueuePosition = () => {
        ...
        if(availableTickets. PurchasedTickets >= availableTickets.totalTickets) {
          <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-gray-200">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between p-3 bg-amber-50 rounded-lg border border-amber-100">
              <div className="flex items-center">
                ...
                <span className="text-amber-700 font-medium"> 
                  You&apos;re next in line (Oueue position: {""}
      ...
      const renderTicketStatus = () => {
        ...
        if(isEventOwner) {
          return(
            <div className="mt-4">
              ...
              className="w-full bg-gray-100 text-gray-700 px-6 py-3 rounded-lg font-medium hover:bg-gray-200 transition-colors durtion-200 shadow-sm flex items-center justify-center gap-2"
              >
        ...
        if(userTicket) {
          return(
            <div className="mr-4 flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-100">
              <div className="flex items-center">
  ...
  return (
    ...
    className={`bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 cursur-pointer overflow-hidden relative ${
    ...
    > 
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        ...
        <div className="flex flex-col items-end gap-2 ml-4">
          ...
          {availableTickets.PurchasedTickets >= availableTickets.totalTickets && (
            ...
            <span>
              ...
              {!isPastEvent && availableTickets.activeOffers > 0 && (
                <span className="text-amber-600 text-sm ml-2">
                  ...
                  {availableTickets.activeOffers === 1 ? "person" : "people"} trying to buy)
